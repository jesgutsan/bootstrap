...
> Los píxeles indican **CUÁNDO cambia el diseño**,  
> las columnas indican **CUÁNTO espacio ocupa**.
...
Bootstrap permite añadir **márgenes** y **rellenos** usando clases,
sin escribir CSS.
...
Bootstrap usa valores de **0 a 5**:
